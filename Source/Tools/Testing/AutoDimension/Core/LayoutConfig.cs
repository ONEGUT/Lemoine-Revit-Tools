namespace LemoineTools.Tools.Testing.AutoDimension.Core
{
    ...
    public sealed class LayoutConfig
    {
        ...
        /// <summary>Paper-space gap between stacked dimension strings. Default 3/8".</summary>
        public double StringSpacingFt { get; set; } = (3.0 / 8.0) / 12.0;

        /// <summary>First string's offset from the source run. Default 3/8".</summary>
        ...
        /// <summary>Soft penalty per foot of text overflow on a cramped segment.</summary>
        public double CrampedWeight { get; set; } = 10.0;
        ...
        /// <summary>Soft penalty per leadered segment (keep leadering rare).</summary>
        public double LeaderWeight { get; set; } = 8.0;
