...
{
    // =========================================================================
    // ToolSettingsSpec — declarative settings data model
    //
    // Replaces the old GetSettingRows() / LemoineSettingRow pattern.
    // Tools return one of these from IToolSettings.GetSettingsSpec().
    ...
    /// <summary>
    /// Top-level declarative specification returned by <see cref="IToolSettings.GetSettingsSpec"/>.
    ...
    /// </summary>
    public sealed class ToolSettingsSpec
    {
        ...
        public List<SettingsGroup> Groups { get; set; } = new List<SettingsGroup>();
    }

    /// <summary>
    /// A collapsible section within a tool's settings panel, containing one or more
    /// <see cref="SettingDef"/> entries rendered as labelled controls.
    /// </summary>
    public sealed class SettingsGroup
    {
        ...
        public List<SettingDef> Settings { get; set; } = new List<SettingDef>();
    }
    ...
    public sealed class TogglesOpts       { public System.Collections.Generic.List<LemoineTools.Framework.Controls.ToggleItem> Items { get; set; } = null!; }
