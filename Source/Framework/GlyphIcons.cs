...
namespace LemoineTools.Framework
{
    ...
    public static class GlyphIcons
    {
        ...
        /// </summary>
        public static TextBlock Build(GlyphIcon icon, string sizeToken = "LemoineFS_MD")
        {
        ...
        public static TextBlock Build(GlyphIcon icon, string sizeToken, string foregroundToken)
        {
