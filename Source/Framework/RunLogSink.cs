...
{
    // =========================================================================
    // RunLogSink — the active run's Output-log sink.
    //
    // Process-wide Revit failure/dialog capture (RevitFailureCapture) fires on
    ...
    // =========================================================================
    public static class RunLogSink
    {
        ...
        public static void Push(string text, string status = "info")
        {
            ...
            catch (Exception ex) { DiagnosticsLog.Swallowed("RunLogSink.Push", ex); }
        }
    }
}
