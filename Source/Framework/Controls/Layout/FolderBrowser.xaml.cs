...
{
    /// <summary>
    /// Folder-path picker — the directory twin of <see cref="FileBrowser"/>.
    ...
    public partial class FolderBrowser : UserControl
    {
        ...
        public string DialogTitle { get; set; } = AppStrings.T("controls.inputs.folderBrowser.defaultDialogTitle");
        ...
        private void ApplyResourceReferences()
        {
            ...
            _browseBtn.Template = ControlStyles.BuildFlatButtonTemplate();
