...
namespace LemoineTools.Framework.Controls
{
    ...
    ///
    /// Replaces ad-hoc imperative section-building and the bare TextBlock group
    /// headers in StepFlowWindow.BuildSettingsPanel().
    ///
    /// Usage:
    ...
    public partial class SectionCard : UserControl
    {
        ...
        public static readonly DependencyProperty CardContentProperty =
            DependencyProperty.Register(
                nameof(CardContent), typeof(UIElement), typeof(SectionCard),
        ...
        {
            if (d is SectionCard card && card._headerText != null)
        ...
        {
            if (d is SectionCard card && card._contentSlot != null)
