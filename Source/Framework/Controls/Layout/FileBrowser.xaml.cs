...
namespace LemoineTools.Framework.Controls
{
    public partial class FileBrowser : UserControl
    {
        ...
        public string Filter      { get; set; } = AppStrings.T("controls.inputs.fileBrowser.defaultFilter");
        public string DialogTitle { get; set; } = AppStrings.T("controls.inputs.fileBrowser.defaultDialogTitle");
