...
namespace LemoineTools.Framework.Controls
{
    ...
    public partial class DateField : UserControl
    {
        ...
        public DateField() => InitializeComponent();
        ...
        private void Rebuild()
        {
            ...
            else
            {
                ...
                var fromHdr   = MiniLabel(AppStrings.T("controls.inputs.datePicker.from"));
                ...
                var toHdr   = MiniLabel(AppStrings.T("controls.inputs.datePicker.to"));
