...
namespace LemoineTools.Framework
{
    ...
    public partial class GlobalSettingsWindow
    {
        ...
        private UIElement BuildCeilingsGroupContent()
        {
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.hmSub")));
            AddColorRow(panel, AppStrings.T("globalSettings.groups.lowColor"),    () => hm.ColorLow,  v => { hm.ColorLow  = v; hm.Save(); });
            AddColorRow(panel, AppStrings.T("globalSettings.groups.midColor"),    () => hm.ColorMid,  v => { hm.ColorMid  = v; hm.Save(); });
            AddColorRow(panel, AppStrings.T("globalSettings.groups.highColor"),   () => hm.ColorHigh, v => { hm.ColorHigh = v; hm.Save(); });
            AddCfgStepper(panel, AppStrings.T("globalSettings.groups.elevTol"),
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.mgSub")));
            AddTextRow(panel, AppStrings.T("globalSettings.groups.dwgFolder"), mg.OutputFolder,
        ...
        private UIElement BuildViewsGroupContent()
        {
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.scopeBoxSub")));
            AddCfgStepper(panel, AppStrings.T("globalSettings.groups.cropBuffer"),
                AppStrings.T("globalSettings.groups.cropBufferDesc"),
                sb.BufferXY, 0, 100, 1, 1, v => { sb.BufferXY = v; sb.Save(); });
            AddCfgStepper(panel, AppStrings.T("globalSettings.groups.clusterThreshold"),
                AppStrings.T("globalSettings.groups.clusterThresholdDesc"),
                sb.ClusterThreshold, 0, 500, 1, 1, v => { sb.ClusterThreshold = v; sb.Save(); });
            AddCfgStepper(panel, AppStrings.T("globalSettings.groups.topLevelHeight"),
        ...
        private UIElement BuildExportGroupContent()
        {
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.bulkSub")));
            AddTextRow(panel, AppStrings.T("globalSettings.groups.outputFolder"), be.OutputFolder,
                v => { be.OutputFolder = v; be.Save(); }, mono: true);
            AddTextRow(panel, AppStrings.T("globalSettings.groups.sheetPattern"), be.FilenamePattern,
                v => { be.FilenamePattern = v; be.Save(); }, mono: true);
            AddTextRow(panel, AppStrings.T("globalSettings.groups.viewPattern"), be.ViewFilenamePattern,
                v => { be.ViewFilenamePattern = v; be.Save(); }, mono: true);

            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.defaultFormats")));
        ...
        private UIElement BuildCopyGroupContent()
        {
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.linearSub")));
            ...
            panel.Children.Add(SubLabel(AppStrings.T("globalSettings.groups.elementsSub")));
