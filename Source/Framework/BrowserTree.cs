...
namespace LemoineTools.Framework
{
    ...
    /// opens. Consumed by <c>BrowserTreePicker</c> so view/sheet pickers
    /// mirror the browser's folder titles, nesting, and ordering exactly.
    /// </summary>
    public sealed class BrowserTree
    {
        /// <summary>
        ...
        /// </summary>
        public List<BrowserNode> Roots { get; } = new List<BrowserNode>();
    }
    ...
    public sealed class BrowserNode
    {
        ...
        public List<BrowserNode> Children { get; } = new List<BrowserNode>();
