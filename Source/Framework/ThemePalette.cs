...
namespace LemoineTools.Framework
{
    ...
    public class ThemePalette
    {
        ...
        public FontFamily IconFont  { get; set; } = ThemePalette._iconFont;
        ...
        /// </summary>
        public static readonly ThemePalette DarkMono = new ThemePalette
        {
            Name     = "Dark Mono",
            Swatch   = B("#1a1a1a"),
            PageBg   = B("#111111"),
        ...
        /// </summary>
        public static readonly ThemePalette DarkNavy = new ThemePalette
        {
            Name     = "Dark Navy",
            Swatch   = B("#0b0d14"),
            PageBg   = B("#060810"),
        ...
        /// </summary>
        public static readonly ThemePalette LightClean = new ThemePalette
        {
            Name     = "Light Clean",
            Swatch   = B("#ffffff"),
            PageBg   = B("#f0f0ee"),
        ...
        /// </summary>
        public static readonly ThemePalette LightWarm = new ThemePalette
        {
            Name     = "Light Warm",
            Swatch   = B("#fdf8f2"),
            PageBg   = B("#ede8e0"),
        ...
        /// </summary>
        public static readonly ThemePalette Stone = new ThemePalette
        {
            Name     = "Stone Gray",
            Swatch   = B("#4a4a4a"),
            PageBg   = B("#2e2e2e"),
        ...
        /// </summary>
        public static readonly ThemePalette Terra = new ThemePalette
        {
            Name     = "Terra",
            Swatch   = B("#4a7c59"),
            PageBg   = B("#ede8dc"),
        ...
        /// </summary>
        public static readonly ThemePalette Sahara = new ThemePalette
        {
            Name     = "Sahara",
            Swatch   = B("#c2652a"),
            PageBg   = B("#ede8de"),
        ...
        /// </summary>
        public static readonly ThemePalette Obsidian = new ThemePalette
        {
            Name     = "Obsidian",
            Swatch   = B("#a78bfa"),
            PageBg   = B("#050507"),
