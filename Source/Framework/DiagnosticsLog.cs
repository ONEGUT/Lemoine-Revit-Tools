...
namespace LemoineTools.Framework
{
    ...
    public static class DiagnosticsLog
    {
        ...
        private static void AppendToFile(Entry entry)
        {
            ...
            {
                Debug.WriteLine("DiagnosticsLog: could not write diagnostics file — " + ioEx.Message);
            }
        }
        ...
        private static void RollIfTooLarge(string path)
        {
            ...
            {
                Debug.WriteLine("DiagnosticsLog: could not roll diagnostics file — " + rollEx.Message);
            }
        }
