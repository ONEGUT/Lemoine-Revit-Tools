    ...
    public static class ToolsOverviewDemos
    {
            ...
            var specs = new Dictionary<string, OverviewDemoSpec>
        {
            ...
            ["Bulk Views by Level"] = new OverviewDemoSpec
            {
                ...
                Steps = new[]
                {
                    MultiFlat("S1", LemoineStrings.T("overviewDemos.tools.bulkViewsByLevel.steps.s1.title"), true, LemoineStrings.T("overviewDemos.tools.bulkViewsByLevel.steps.s1.hint"), Levels),
